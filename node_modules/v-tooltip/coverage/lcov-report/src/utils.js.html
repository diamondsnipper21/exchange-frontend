...
export function removeClasses (el, classes) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (el instanceof SVGElement) {
<span class="cstat-no" title="statement not covered" >		el.setAttribute('class', classList.join(' '))</span>
	} else {
		el.className = classList.join(' ')
	}
}
