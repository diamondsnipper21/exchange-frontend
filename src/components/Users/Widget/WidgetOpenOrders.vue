    ...
    <table-container>
      ...
      <div slot="no-data" class="cce-nodata-center">
        <span class="cce-trade__table-td cce-opacity">
          {{ $t('UserOpenOrdersWidget.have_no_open_orders') }} ({{$t('TradeUserOrders.selected')}} {{ timeframeToFilterBy }})
        </span>
      </div>
        ...
        <template slot="items" slot-scope="props">
          <tr class="cce-trade__table-tr">
            ...
            <table-cell subheader>
              <span
                @click="showCancelModal(props.item)"
              ...
              <tr id="openOrdersTotalRow">
                ...
                <td class="cce-trade__table-td">
                  <div class="group cce-opacity no-wrap">
                    <span v-fixed-number="totalSummary.totalBuyAmount"></span>
                    <span class="cce-uppercase">{{ totalSummary.marketType }}</span> /
                    <span v-fixed-number="totalSummary.totalSellAmount"></span>
      ...
      <template>
        <widget-modal
          :title="$t('AdminManageUser.modal_cancel_title')"
          :message="$t('AdminManageUser.modal_cancel_message')"
          v-if="isModalVisible"
...
export default {
  ...
  methods: {
    ...
    async cancelOrder() {
      ...
      const orderUid = this.selectedItem.orderUid;
