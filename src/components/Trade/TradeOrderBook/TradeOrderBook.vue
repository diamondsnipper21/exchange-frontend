  ...
  export default {
    ...
    data() {
      return {
        ...
        askOrdersFakeRows: 0,
        bidOrdersFakeRows: 0,
        nonBinanceRefresh: null,
      };
    },
    mounted() {
      if (!this.nonBinanceRefresh) {
        this.nonBinanceRefresh = setInterval(() => {
    ...
    beforeDestroy() {
      if (this.nonBinanceRefresh) {
        clearInterval(this.nonBinanceRefresh);
      }
    },
    computed: {
      // change precision
